  ...
  @foreach ($m as $l)
              <tr>
                  ...
                  <td>
                <a  href="{{ route('SupprimerTechnicien', ['id' => $l->id]) }}" style="color:red" title="Supprimer" class="far fa-trash-alt"  onclick="return confirm('Etes-vous sur ?');"></a>
              ...
              @endforeach
              <a class="btn btn-primary" href="{{route('AjouterTechnicien')}}" role="button">Ajouter </a>
              <ul class="list-unstyled topnav-menu  float-right mb-0">
