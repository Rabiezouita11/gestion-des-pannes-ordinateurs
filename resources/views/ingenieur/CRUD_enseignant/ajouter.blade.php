...
<div class="container">
 	...
 	<br/>
<form action="{{route('AjoutEnseignant')}}" method="post" enctype="multipart/form-data" >
     ...
     <label>Role</label>
     <input class="form-control" type="text" name="role" value="enseignant" readonly></br>
     <label>email</label>
 	...
 	<a href="{{route('listeEnseignant')}}" class="btn btn-default">Annuler</a>
